...
<form method="POST" id="form-validate" name="form-validate" action="{{ url('admin/posts/add') }}">
            ...
            <div class="tab-content">
                <div id="content" class="tab-pane fade in active">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control inline" name="title" id="title" placeholder="Post Title" type="text"/>
                    </div>


                    <div class="spacer"></div>
                    <textarea type="text" class="form-control spacer" name="content" id="content"  value=""></textarea>
                    <div class="spacer"></div>
